            ...
            <ScrollableWindowRelative heightPercent={100}>
              <div style={{ marginTop: 10, marginBottom: 10, paddingRight: 6 }}>
                ...
                <p style={paragraphStyle}>
                  ...
                  “Use Virtual Surround Sound as Default Output” option and try again. You should also avoid using this feature
                  when you connect to an external multichannel system such as a home theatre receiver or soundbar. This plugin
                  is designed to down mix surround to 2 channels for headphones, not to feed real 5.1 or 7.1 speakers.
                </p>
                ...
                <p style={italicStyle}>
                  TLDR; Enabling the Virtual Surround Sound sink as the default is recommended for headphone setups where you
                  want surround capable apps to send 5.1 or 7.1 into the plugin. If you prefer to use an external surround
                  system or run into audio routing problems, leave your normal output as default and only select the virtual
                  surround sink when you need it.
                </p>
              </div>
